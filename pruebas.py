...
def main():
    ...
    global nombre_usuario                                   #* Necesario para usar el nombre en otras funciones, la convierte en variable global
    ...
    while True:                                             #* Ciclo para asegurar una elección válida
